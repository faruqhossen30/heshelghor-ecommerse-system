<div class="product product-single row mb-4 product-popup">
			...
			<div class="product-single-carousel owl-carousel owl-theme owl-nav-inner row cols-1">
				...
				<figure class="product-image">
					<img src="images/product/product-2-580x580.jpg"
						data-zoom-image="images/product/product-2-800x900.jpg" alt="Blue Pinafore Denim Dress"
						width="580" height="580">
				</figure>
				<figure class="product-image">
					<img src="images/product/product-3-580x580.jpg"
						data-zoom-image="images/product/product-3-800x900.jpg" alt="Blue Pinafore Denim Dress"
						width="580" height="580">
				</figure>
				<figure class="product-image">
					<img src="images/product/product-4-580x580.jpg"
						data-zoom-image="images/product/product-4-800x900.jpg" alt="Blue Pinafore Denim Dress"
						width="580" height="580">
				</figure>
				<figure class="product-image">
					<img src="images/product/product-5-580x580.jpg"
						data-zoom-image="images/product/product-5-800x900.jpg" alt="Blue Pinafore Denim Dress"
						width="580" height="580">
				</figure>
			</div>
	...
	<div class="col-md-6">
		<div class="product-details scrollable">
			<h2 class="product-name"><a href="product.html">Blue Pinafore Denim Dress</a></h2>
