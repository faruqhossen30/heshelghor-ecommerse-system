<div class="product-wrap fade">
    <div class="product">
        <figure class="product-media">
            <a href="product.html">
                <img src="images/shop/16.jpg" alt="product" width="280" height="315">
            </a>
        ...
        <div class="product-details">
            ...
            <h3 class="product-name">
                <a href="product.html">Coast Pool Comfot Jacket</a>
            </h3>
            ...
            <div class="ratings-container">
                ...
                <a href="#" class="rating-reviews">( <span class="review-count">6</span> reviews )</a>
            </div>
        </div>
    </div>
</div>
...
<div class="product-wrap fade">
    <div class="product">
        ...
        <div class="product-details">
            <div class="product-cat">
                <a href="shop-grid-3col.html">clothings</a>
            </div>
            <h3 class="product-name">
...
<div class="product-wrap fade">
    <div class="product">
        <figure class="product-media">
            <a href="product.html">
                <img src="images/shop/17.jpg" alt="product" width="280" height="315">
            </a>
            <div class="product-action-vertical">
                <a href="#" class="btn-product-icon btn-cart" data-toggle="modal" data-target="#addCartModal"
                    title="Add to cart"><i class="d-icon-bag"></i></a>
        ...
        <div class="product-details">
            ...
            <h3 class="product-name">
                <a href="product.html">Fashion Padded Jacket</a>
            </h3>
            <div class="product-price">
...
<div class="product-wrap fade">
    <div class="product">
        <figure class="product-media">
            <a href="product.html">
                <img src="images/shop/18.jpg" alt="product" width="280" height="315">
            </a>
            <div class="product-action-vertical">
                <a href="#" class="btn-product-icon btn-cart" data-toggle="modal" data-target="#addCartModal"
                    title="Add to cart"><i class="d-icon-bag"></i></a>
...
<div class="product-wrap fade">
    <div class="product">
        <figure class="product-media">
            <a href="product.html">
                <img src="images/shop/19.jpg" alt="product" width="280" height="315">
            </a>
            <div class="product-action-vertical">
                <a href="#" class="btn-product-icon btn-cart" data-toggle="modal" data-target="#addCartModal"
                    title="Add to cart"><i class="d-icon-bag"></i></a>
...
<div class="product-wrap fade">
    <div class="product">
        <figure class="product-media">
            <a href="product.html">
                <img src="images/shop/20.jpg" alt="product" width="280" height="315">
            </a>
            <div class="product-action-vertical">
                <a href="#" class="btn-product-icon btn-cart" data-toggle="modal" data-target="#addCartModal"
                    title="Add to cart"><i class="d-icon-bag"></i></a>
...
<div class="product-wrap fade">
    <div class="product">
        <figure class="product-media">
            <a href="product.html">
                <img src="images/shop/21.jpg" alt="product" width="280" height="315">
            </a>
            <div class="product-action-vertical">
                <a href="#" class="btn-product-icon btn-cart" data-toggle="modal" data-target="#addCartModal"
                    title="Add to cart"><i class="d-icon-bag"></i></a>
        ...
        <div class="product-details">
            <div class="product-cat">
                <a href="shop-grid-3col.html">men's</a>
            </div>
            <h3 class="product-name">
