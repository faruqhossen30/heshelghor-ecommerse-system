                ...
                <div class="card">
                    ...
                    @endif --}}
                        <div class="">
                            ...
                            @if (Carbon\Carbon::parse($order->created_at)->addMinutes(30)->greaterThan(Carbon\Carbon::now()))
                                <div class="countdown"
                                    data-expire="{{ Carbon\Carbon::parse($order->created_at)->addMinutes(30)->format('Y/m/d H:i:s') }}">

                                    <span id="clock" class="text-danger" style="font-size: 35px"></span>
                                </div>
                                <h5 class="mt-0">
                                    <a href="{{ route('user.order.cancel', $order->id) }}" type="button"
                                        class="btn btn-danger btn-sm waves-effect waves-light"
                                        onclick="return confirm('Are you want to complain about this order ?');">
                                    ...
                                    <div class="d-flex mb-2">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <h5 class="mt-0">
                                                ...
                                                <small
                                                    class="text-muted">{{ Carbon\Carbon::parse($order->created_at)->format('h:m A') }}</small>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="me-3">
                                                                        <img src="{{ $item->product->img_small }}"
                                                                            alt="product_imgsmall" height="40">
                                                                    </div>
                                                                    <div class="flex-1">
                                ...
                                <td>
                                    @if ($item->cancel_status == 0)
                                        <a href="{{ route('user.order.track', $item->id) }}"
                                            class="badge badge-soft-danger">Trace Order </a>
                                    @endif
