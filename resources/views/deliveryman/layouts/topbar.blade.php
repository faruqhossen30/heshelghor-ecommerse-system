            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="pro-user-name ms-1">
                        ...
                        {{Auth::guard('deliveryman')->user()->name}} <i class="mdi mdi-chevron-down"></i>
                        @endauth
                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                    ...
                    <a class="dropdown-item notify-item" href="{{ route('deliveryman.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        <i class="ri-logout-box-line"></i>
                        <span>{{ __('Logout') }}</span>
                        </a>

                        <form id="logout-form" action="{{ route('deliveryman.logout') }}" method="POST" class="d-none">
                            @csrf
                        </form>
