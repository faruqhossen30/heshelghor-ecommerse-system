...
<main class="main" style="height: 100vh">
    <div class="page-content">
        <section
            ...
            <h1 class="mb-2 ls-m">404 Page Not Found !</h1>
            <img src="{{asset('frontend/images/404.png')}}" alt="error 404" width="609" height="131">
            ...
            <a href="{{route('homepage')}}" class="btn btn-primary btn-rounded mb-4">Go home</a>
        </section>
    </div>
</main>
@endsection
