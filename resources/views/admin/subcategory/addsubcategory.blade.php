                                                ...
                                                <div class="p-2">
                                                    <form method="POST" action="{{route('subcategory.store')}}" enctype="multipart/form-data" class="form-horizontal" role="form" >
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input value="0" name="commission" type="text" id="simpleinput" class="form-control @error('commission') is-invalid @enderror " placeholder="commission">
                                                                <div class="text-danger">
                                                                    @error('commission')
                                                                    <span>{{ $message }}</span>
                                                                    @enderror
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-10">
                                                                ...
                                                                <input name="photo" type="file" id="simpleinput" class="form-control @error('image') is-invalid @enderror"
