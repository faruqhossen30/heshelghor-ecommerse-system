    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box page-title-box-alt">
                <h4 class="page-title">withdrawrals </h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-3">
                            <h4 class="header-title text-derk mt-1">withdrawrals List</h4>
                        </div>
                        <div class="col-sm-9">
                        ...
                        <table class="table table-bordered mb-2">
                            ...
                            <tbody id="tableBody">
                                ...
                                <tr>
                                    ...
                                    <td><h5 class="mt-0">
                                        {{ Carbon\Carbon::parse($withdraw->created_at)->format('d M') }}
                                        <small class="text-muted">
                                            {{ Carbon\Carbon::parse($withdraw->created_at)->format('h:m A') }}
                                        </small>
                                    </h5></td>
                                    ...
                                    <td>
                                       ...
                                       @if($withdraw->status == 1)
                                          <a href="{{route('payment.status',$withdraw->id)}}" class="btn btn-sm btn-danger">Rejected</a>
                                        @else
                                             <a href="{{route('payment.status',$withdraw->id)}}" class="btn  btn-sm btn-success">Accepted</a>
                                         @endif
                                    </td>

                                    <td>
                                        <a class="btn btn-success btn-sm text-white"
                                            href="{{ route('merchant.payment.details',$withdraw->id)}}"
