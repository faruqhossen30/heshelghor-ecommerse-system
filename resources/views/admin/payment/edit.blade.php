        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box page-title-box-alt">
                    <h4 class="page-title">Update Payment Method</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="p-2">
                                                    <form method="POST" action="{{route('paymentmethod.update', $paymentmethod->id)}}" class="form-horizontal" role="form" >
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input name="name" value="{{ $paymentmethod->name }}" type="text" id="simpleinput" class="form-control @error('name') is-invalid @enderror " placeholder="Name">
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea name="description"  class="form-control @error('description') is-invalid @enderror" id="example-textarea"
                                                                    rows="5" placeholder="Brand description..."> {{ $paymentmethod->description }} </textarea>
                                                                <div class="text-danger">
                                                                    @error('description')
                                                                    <span>{{ $message }}</span>
                                                                    @enderror
