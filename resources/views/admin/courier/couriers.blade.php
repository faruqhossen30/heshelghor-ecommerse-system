            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box page-title-box-alt">
                        <h4 class="page-title">Cuorier Service List</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">HeshelGhor</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">eCommerce</a></li>
                                <li class="breadcrumb-item active">Delivery Service List</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <a href="{{ route('courier.create') }}" class="btn btn-success mb-2"><i
                                            class="mdi mdi-plus-circle me-1"></i> Add Delivery System</a>
                                </div>
                                <div class="col-sm-6">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0 d-inline-block align-middle"><a href="#"
                                                            class="text-dark">{{ $courier->name }}</a></h5>
                                                </td>

                                                <td>
                                                    {{ Carbon\Carbon::parse($courier->created_at)->diffForHumans() }}
                                                </td>
                                                <td>
