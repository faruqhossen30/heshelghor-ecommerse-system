            ...
            <hr>
                <form  action="{{ route('admin.update', $admin->id) }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="name" value="{{$admin->name}}" class="form-control" id="name" placeholder="TYPE FULL NAME" required>
                        @error('name')
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="email" value="{{$admin->email}}" class="form-control" id="email" placeholder="TYPE EMAIL" required>
                        @error('email')
                            <div class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </div>
