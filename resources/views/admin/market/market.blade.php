            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if ($admin->can('market.create'))
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <a href="{{ route('market.create') }}" class="btn btn-primary mb-2"><i
                                                class="mdi mdi-plus-circle me-1"></i> Create Market</a>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="float-sm-end">
                                            <button type="button" class="btn btn-primary mb-2 mb-sm-0"><i
                                                    ...
                                                    @if ($admin->can('market.delete'))
                                                        <form action="{{ route('market.destroy', $market->id) }}"
                                                            ...
                                                            <button class="btn btn-danger btn-sm" type="submit"
                                                                onclick="return confirm('Sure ? Want to delete market ?')"><i
