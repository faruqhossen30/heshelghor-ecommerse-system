                            ...
                            <form action="{{ route('admin.productUpdate', $product->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="subcategory_id" value="{{ $product->subcategory_id }}"
                                                class="form-control" id="product-category">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="brand_id" class="form-label text-dark">Brand <span
                                                    class="text-danger">*</span></label>
                                            <select name="brand_id" value="{{ $product->brand_id }}"
                                                class="form-control selectize-drop-header" id="select-code-language">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="shop_id" class="form-label text-dark">Select Shop <span
                                                    class="text-danger">*</span></label>
                                            <select name="shop_id" value="{{ $product->shop_id }}"
                                            ...
                                            <select name="division_id"
                                                ...
                                                @foreach ($divisions as $division)
                                                    <option value="{{ $division->id }}"
                                                        {{ $product->division_id == $division->id ? ' selected ' : '' }}>
                                            ...
                                            <select name="upazila_id"
                                                ...
                                                @foreach ($upazilas as $upazila)
                                                    <option value="{{ $upazila->id }}"
                                                        {{ $product->upazila_id == $upazila->id ? ' selected ' : '' }}>
                                                        {{ $upazila->name }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="regular_price" type="number"
                                                ...
                                                id="retularPrice" value="{{ $product->regular_price }}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="quantity_alert" type="text"
                                                ...
                                                id="quantityAlerm" value="{{ $product->quantity_alert }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_description" class="form-control @error('short_description') is-invalid @enderror"
                                        id="product-summary" rows="5">{{ $product->short_description }}</textarea>
                                    <div class="text-danger">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="youtube_link" type="text" value="{{ $product->youtube_link }}"
                                        class="form-control">
                                    @error('youtube_link')
                                        <span>{{ $message }}</span>
                                    @enderror
                                            ...
                                            <div style="display: flex; flex-wrap: wrap; ">
                                                @foreach ($colors as $color)
                                                    <div class="form-check" style="margin-right: 5px">
                                                        <input @if (in_array(['color_id' => $color->id], $colorArray)) checked @endif
                                                            name="colors[]"
                                ...
                                <div id="productImageMediaArea">
                                    ...
                                    <div id="selectedProductImageMedia">
                                        <img src="{{ $product->img_full }}" alt=""
                                            class="img-responsive p-2 img-thumbnail" style="width:100px;height:100px">
                                        <button id="selectedProductImageMediaCloseButton" type="button"
                                        ...
                                        @foreach ($images as $image)
                                            <div class="selectedProductImageMedia p-1" style="text-align:center">
                                                <img src="{{ $image->url }}" alt=""
                                                    class="img-responsive p-2 img-thumbnail"
                                                    style="width:150px;height:150px"> <br>
                                                <button type="button"
                                                    class="selectedProductImageMediaCloseButton btn btn-danger btn-sm mt-1">
                                                    Close</button>
                                                <input type="hidden" name="fullsizeimages[]"
                                                    value="{{ $image->url }}">
                                            </div>
                                        @endforeach
