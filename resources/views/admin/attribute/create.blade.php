                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{route('attributevalue.careate', $attribute->id)}}" class="btn btn-sm btn-success waves-effect waves-light"><i class="mdi mdi-cog"></i></a>
                                            <a href="{{route('attribute.edit', $attribute->id)}}" class="btn btn-sm btn-warning waves-effect waves-light"><i class="mdi mdi-pencil-box-outline"></i></a>
                    ...
                    <div class="card-body">
                        <form action="{{route('attribute.store')}}" method="post">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="name" class="form-control" id="exampleName" aria-describedby="emailHelp" placeholder="Atrribute name">
                            </div>
