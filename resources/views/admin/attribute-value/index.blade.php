                    ...
                    <table id="basic-datatable" class="table table-responsive dt-responsive w-100 table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-success" title="View"><span class="mdi mdi-eye"></span></a>
                                    <a href="#" class="btn btn-primary" title="Edit"><span class="mdi mdi-pencil"></span></a>

                                    <form action="" method="post" style="display: inline" >
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger" type="submit" onclick="confirm('Sure ? Want to delete Tender ?')"><i class="mdi mdi-delete"></i></button>
                                    </form>
