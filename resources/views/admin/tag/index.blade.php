        ...
        <div class="page-title-box page-title-box-alt">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Attribute List</a></li>
                </ol>
            </div>
        </div>
    </div>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <a href="{{route('attribute.create')}}" class="btn btn-success mb-2"><i class="mdi mdi-plus-circle me-1"></i>Create Attribute</a>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <table id="basic-datatable" class="table table-responsive dt-responsive w-100 table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('attributevalue.careate', $attribute->id)}}" class="btn btn-success" title="Edit"><span class="mdi mdi mdi-cog"></span></a>
                                    <a href="{{route('attribute.edit', $attribute->id)}}" class="btn btn-primary" title="Edit"><span class="mdi mdi-pencil"></span></a>

                                    <form action="{{route('attribute.destroy', $attribute->id)}}" method="post" style="display: inline" >
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger" type="submit" onclick="confirm('Sure ? Want to delete Attribute ?')"><i class="mdi mdi-delete"></i></button>
                                    </form>
