                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="p-2">
                                                    <form method="POST" action="{{route('slider.store')}}" enctype="multipart/form-data" class="form-horizontal" role="form" >
                                                        @csrf
                                                        <div class="mb-2 row">
                                                            <label class="col-md-2 col-form-label"
                                                                for="simpleinput">link<span class="text-danger">*</span></label>
                                                            <div class="col-md-10">
                                                                <input name="link" value="{{ old('link') }}" type="text" id="simpleinput" class="form-control @error('link') is-invalid @enderror " placeholder="link">
