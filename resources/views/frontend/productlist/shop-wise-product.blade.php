                    ...
                    <div class="col-lg-9 main-content">
                        <div class="card mb-3">
                            <div class="row g-0">
                                <div class="col-md-3">
                                    @if ($shop->image)
                                    <img src="{{ asset('uploads/shop/' . $shop->image) }}" class="card-img-top img-thumbnail" style="width: 150px; height:150px" alt="{{ $shop->name }}">
                                    @else
                                    <img src="{{ asset('frontend/images/shop.png') }}" class="card-img-top img-thumbnail" style="width: 150px; height:150px" alt="{{ $shop->name }}">
                                    @endif
                                </div>
                                <div class="col-md-9">
                                    <div class="card-body">
