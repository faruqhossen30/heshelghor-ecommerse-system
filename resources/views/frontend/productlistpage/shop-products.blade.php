                    ...
                    <div class="search-sidebar">
                        <div class="card mb-2">
                            ...
                            <ul class="expandible">
                                ...
                                <li>
                                    <input type="checkbox" id="vehicle1" name="category[]" value="{{$category->id}}" onchange="this.form.submit()"
                        ...
                        <a href="#" class="single-shop shop_links market-links ">
                            <div class="single-market hover-none bg-white d-flex ">
                                <div class="shop-photo market-photo">
                                    <img class="lozad" data-src="{{asset('uploads/shop/'.$shop->image)}}" data-placeholder-background="white" onerror="this.onerror=null;this.src='{{asset('frontend/images/placeholder.jpg')}}';"  alt="{{$shop->name}}" style="height: 100px; width:auto">
                                </div>
