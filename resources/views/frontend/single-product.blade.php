                            ...
                            @if (count($product->sizes) > 0)
                                <div class="my-3">
                                    ...
                                    @foreach ($product->sizes as $size)
                                        <input type="radio" class="btn-check" name="btnradio"
                                            id="size{{ $size->id }}" autocomplete="off">
                                        <label class="btn btn-outline-secondary btn-sm"
                                            for="size{{ $size->id }}">{{ $size->size->name }}</label>
                                    @endforeach
                                </div>
                            @endif
                            ...
                            @if ($product->quantity > 0)
                                ...
                                <div class="">
                                    ...
                                    <a href="{{ route('buynow', $product->id) }}"
                                        class="btn btn-primary btn-sm hg-iconbutton quick-view-buynow "><i
                    ...
                    <div class="product-delivery-location">
                        ...
                        <ul class="aditional-ifno">
                            <li><i class="fa-solid fa-user"></i> Please Contact, for <strong>Details</strong> or
                                <strong>Buy</strong></li>
                            <li><i class="fa-solid fa-headphones-simple"></i><strong> Heshelghor</strong> : +88 02477763843</li>
                            <li><i class="fa-solid fa-phone"></i><strong> Mobile</strong> : +88 01318-760087, +88 01859-348860 , +88 01715-127719</li>
                        </ul>
                        @endif
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab2" data-bs-toggle="tab" data-bs-target="#comment"
                                type="button" role="tab" aria-controls="comment"
                                aria-selected="false">Comments</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab3" data-bs-toggle="tab" data-bs-target="#faq"
                                type="button" role="tab" aria-controls="faq" aria-selected="false">FAQ</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab4" data-bs-toggle="tab" data-bs-target="#review"
                    ...
                    <div class="single-related-producted">
                        <div class="single-product ">
                            <div class="product-photo position-relative">
                                <img src="{{ asset('frontend') }}/images/shop/shop.png" alt="product_img"
                                    class="product_img">
                                ...
                                <div class="product-btn">
                                    <button data-bs-target="#exampleModalToggle2" data-bs-toggle="modal"
                                        data-bs-dismiss="modal">quick view</button>
                                </div>
                            </div>
