                                ...
                                @if ($product->category_id != 38)
                                    <div class="d-flex flex-row">
                                        ...
                                        <button class="btn btn-primary btn-sm hg-iconbutton" id="add-to-cart"
                                            data-id="{{ $product->id }}" type="button" style="margin-left: 5px"><i
                                                class="fas fa-shopping-cart icon-c"></i> Add to
                                            Cart</button>
                                    </div>
                                    <div class="">
                                        <button class="btn btn-primary btn-sm hg-iconbutton"><i
                        ...
                        @if ($product->category_id != 38)
                            <ul>
                                ...
                                <li class="d-flex justify-content-between align-items-center">
                                    <div class="delivery-location-left d-flex align-items-center">
                                        <span class="delivery-icon"><i
                                                class="fa-solid fa-square-root-variable"></i></span>
                            ...
                            <a href="{{ route('shoppage', $product->shop->slug) }}" class="shop_links market-links ">
                                <div class="single-shop single-market d-flex border">
                                    <div class="shop-photo market-photo">
                                        <img data-src="{{ asset('uploads/shop/' . $product->shop->image) }}"
                                            onerror="this.onerror=null;this.src='{{ asset('frontend/images/placeholder.jpg') }}';"
                                            data-placeholder-background="white" alt="{{ $product->shop->name }}"
                                            class="lozad">
                                    </div>
