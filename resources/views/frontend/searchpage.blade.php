                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="search-location-left">
                                                                    <div class="nav flex-column nav-pills me-3"
                                                                        ...
                                                                        @foreach ($divisions as $division)
                                                                            <button class="nav-link" id="{{ $division->name }}"
                                                                                data-bs-toggle="pill"
                                                                                data-bs-target="{{ $division->name }}" type="button"
                                                                                role="tab" aria-controls="{{ $division->name }}"
                                                                                aria-selected="true">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="tab-content" id="v-pills-tabContent">
                                                                    <div class="tab-pane fade show active" id="{{ $division->name }}"
                                                                        role="tabpanel" aria-labelledby="{{ $division->name }}">
                                                                        <h5>Select Your Area</h5>
                                                                        <select name="" class="form-control">
                                                                            <option value="">Select District</option>
                                                                            @foreach ($districts as $district)
                                                                                <option value="{{ $district->id }}" @if (isset($_GET['district'])) @endif   onchange="this.form.submit()">
