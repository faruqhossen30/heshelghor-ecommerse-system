                                            ...
                                            @foreach ($categories as $category)
                                                <div class="form-checkbox my-4 pb-2" style="border-bottom: 1px solid #eee">
                                                    <input type="checkbox" name="category[]" value="{{ $category->id }}"
                                                        class="custom-checkbox" id="category_{{ $category->id }}"
                                                        @if (!empty($filter_category) && in_array($category->id, $filter_category)) checked @endif
                                            ...
                                            @foreach ($brands as $brand)
                                                <div class="form-checkbox my-4 pb-2" style="border-bottom: 1px solid #eee">
                                                    <input type="checkbox" name="brand[]" value="{{ $brand->id }}"
                                                        class="custom-checkbox" id="brand_{{ $brand->id }}"
                                                        @if (!empty($filter_brand) && in_array($brand->id, $filter_brand)) checked @endif
                                                        onchange="this.form.submit();">
                        ...
                        <div class="col-lg-9 main-content">
                            ...
                            <div class="product-variations my-1">
                                <div>
                                    ...
                                    <a
                                        href="{{ route('product.with.subcategory', ['category' => $category->slug, 'slug' => $subcategory->slug]) }}"><span
                                            class="badge bg-primary">{{ $subcategory->name }}</span></a>
                                @endforeach --}}
                                </div>
                            </div>
