            ...
            <div class="container">
                ...
                <div class="row main-content-wrap gutter-lg">
                            ...
                            <div class="sticky-sidebar">
                                ...
                                <div class="widget widget-collapsible">
                                    ...
                                    <ul class="widget-body filter-items">
                                        ...
                                        <div class="form-checkbox my-4 pb-2" style="border-bottom: 1px solid #eee">
                                            <input type="checkbox" name="category[]" value="{{ $category->id }}" class="custom-checkbox" id="category_{{ $category->id }}" @if (!empty($filter_category) && in_array($category->id, $filter_category)) checked @endif
                                ...
                                <div class="widget widget-collapsible">
                                    ...
                                    <ul class="widget-body filter-items">
                                        ...
                                        <div class="form-checkbox my-4 pb-2" style="border-bottom: 1px solid #eee">
                                            <input type="checkbox" name="brand[]" value="{{ $brand->id }}" class="custom-checkbox" id="brand_{{ $brand->id }}" @if (!empty($filter_brand) && in_array($brand->id, $filter_brand)) checked @endif
                                            onchange="this.form.submit();">
                    ...
                    <div class="col-lg-9 main-content">
                        ...
                        <div class="product-variations my-1">
                            <div>
                                <span>Subcategory: </span>
                                {{-- @foreach ($subcategories as $subcategory)
                                    <a
                                        href="{{ route('product.with.subcategory', ['category' => $category->slug, 'slug' => $subcategory->slug]) }}"><span class="badge bg-primary">{{ $subcategory->name }}</span></a>
                                @endforeach --}}
                            </div>
                        </div>
                            ...
                            <div class="toolbox-left">
                                ...
                                <div class="toolbox-item toolbox-sort select-box">
                                    ...
                                    <select name="orderby" class="form-control" onchange="this.form.submit();">
                                        <option value="latest" @if (!empty($_GET['orderby']) && $_GET['orderby']=='latest' ) selected @endif>Latest
                                        </option>
                                        <option value="lowtohigh" @if (!empty($_GET['orderby']) && $_GET['orderby']=='lowtohigh' ) selected @endif>Low
                                            To High</option>
                                        <option value="hightolow" @if (!empty($_GET['orderby']) && $_GET['orderby']=='hightolow' ) selected @endif>High
                                            To Low</option>
                                    </select>
                                </div>
                            </div>
                            <div class="toolbox-right">
                                <div class="toolbox-item toolbox-show select-box">
                                    ...
                                    <select name="count" class="form-control" onchange="this.form.submit();">
                                        <option value="20" @if (request()->query('count') == '20') selected @endif>20
                                        </option>
                                        <option value="40" @if (request()->query('count') == '40') selected @endif>40
                                        </option>
                                        <option value="60" @if (request()->query('count') == '60') selected @endif>60
                                        </option>
                                    </select>
                                </div>
