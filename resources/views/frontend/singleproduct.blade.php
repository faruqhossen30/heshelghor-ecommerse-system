...
<!-- Modal -->
<div class="modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 999999999">
                    ...
                    <div class="product-gallery">
                        <div class="product-single-carousel owl-carousel owl-theme owl-nav-inner row cols-1">
                            <figure class="product-image">
                                <img src="{{ $product->img_full }}" data-zoom-image="{{ $product->img_full }}" alt="Blue Pinafore Denim Dress" width="800" height="900" style="background-color: #f5f5f5;" />
                            </figure>
                            @foreach ($product->images as $image)
                            <figure class="product-image">
                                <img src="{{ $image->url }}" data-zoom-image="{{ $image->url }}" alt="Blue Pinafore Denim Dress" width="800" height="900" style="background-color: #f5f5f5;" />
                            </figure>
                            @endforeach
                        ...
                        <div class="product-thumbs-wrap">
                            <div class="product-thumbs">
                                <div class="product-thumb active">
                                    <img src="{{ $product->img_full }}" alt="product thumbnail" width="137" height="154" style="background-color: #f5f5f5;" />
                                </div>
                                @foreach ($product->images as $image)
                                <div class="product-thumb ">
                                    <img src="{{ $image->url }}" alt="product thumbnail" width="137" height="154" style="background-color: #f5f5f5;" />
                                </div>
                                @endforeach
                ...
                <div class="col-md-6">
                    <div class="product-details  product-gallery-sticky">
                        ...
                        <div class="product-meta">
                            ...
                            CATEGORIES: <a href="#"><span class="product-brand mr-0">{{ $product->category->name }}</span></a>
                            @if (optional($product->subcategory)->name)
                            <a href="{{ route('product.with.subcategory', ['category' => $product->category->slug, 'slug' => $product->subcategory->slug]) }}"><span class="product-brand">| {{ $product->subcategory->name }}</span></a>
                            @endif
                        </div>
                        <div class="product-meta">
                            Brand:
                            @if ($product->brand)
                            <a href="{{ route('product.with.brand', $product->brand->id) }}"><span class="product-brand mr-0">{{ $product->brand->name }}</span></a>
                            @else
                            N/A
                            @endif
                        ...
                        <form action="{{ route('cart.add', $product->id) }}" method="post">
                            ...
                            <div class="mb-3 row">
                                <label for="staticEmail" class="col-sm-2 col-form-label" style="font-size: 1.7rem">Size:</label>
                                <div class="col-sm-4">
                            ...
                            <div class="product-form product-qty">
                                <div class="product-form-group">
                                    ...
                                    @else
                                    <button type="button" class="btn btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="d-icon-heart"></i>
                                        Add To Wishlist
                                    </button>
                                    @endif
                        ...
                        <div class="product-footer">
                            <div class="social-links mr-4">
                                ...
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('singleproduct', $product->slug) }}" class="social-link social-facebook fab fa-facebook-f ml-2"></a>
                    ...
                    <div class="product text-center">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-name">
                                <a href="demo3-product.html"><a href="{{ route('singleproduct', $product->slug) }}">{{ $product->title }}</a>
                            </h3>
