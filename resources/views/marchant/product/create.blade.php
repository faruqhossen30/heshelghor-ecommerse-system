                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="regular_price" type="number" class="form-control" id="retularPrice" placeholder="Regular Price">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="quantity" class="form-label">Alert Quantity<span class="text-danger">*</span></label>
                                                    <input name="quantity_alert" type="text" class="form-control" id="quantity" placeholder="Enter Quantity">
                                                </div>
                                            </div>
