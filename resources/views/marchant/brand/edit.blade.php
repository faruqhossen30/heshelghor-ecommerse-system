                                                ...
                                                <div class="p-2">
                                                    <form method="POST" action="{{route('brand.update', $brand->id)}}" enctype="multipart/form-data" class="form-horizontal" role="form" >
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input name="name" value="{{$brand->name}}" type="text" id="simpleinput" class="form-control" placeholder="Name">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea name="description"  class="form-control" id="example-textarea" rows="5" placeholder="Brand description...">
                                                                    {{$brand->description}}
                                                                </textarea>
                                                            </div>
                                                        </div>
